...
app.layout = html.Div([
    ...
    html.Div([
        dbc.Row(children=[
            ...
            html.P("Choose the region to display its unemployment rate over time."),
            dcc.Dropdown(
                id='region-dropdown',
    ...
    html.Div([
        dbc.Col(children=[
            html.P("Choose the quarter to be displayed on the map."),
            dcc.Dropdown(
                id='date-dropdown',
...
def update_plots(selected_region, selected_date):
    ...
    try:
        ...
        labels={'Average_Unemployment_Rate': 'Average Unemployment Rate (%)', 'Output': 'GDP'}
        )
